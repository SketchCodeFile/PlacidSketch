...
//We set the parameters to be consistent with those of PlacidSketch.
...
#define SmoothThreshold		(200)  //If an item X appears is recognized as steady more than SmoothThreshold times
...
const int memory_size = 400; // the memory occupied by steadyfilter and rollingsketch
